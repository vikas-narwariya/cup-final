    ...
    <AppBar className={classes.appBar} position="static" color="inherit">
      ...
      <Toolbar className={classes.toolbar}>
        {user?.result ? (
          ...
          <Button component={Link} to="/admin/asignin" variant="contained" color="primary">Admin Sign In</Button>
        )}
      </Toolbar>
      <Toolbar className={classes.toolbar}>
        {user?.result ? (
          ...
          <Button component={Link} to="/teacher/tsignin" variant="contained" color="primary">Teacher Sign In</Button>
        )}
      </Toolbar>
    </AppBar>
  );
